...
const initialScreen = () => {
  ...
  <div class="jumbotron">
    ...
    <center><h1 class="display-4">Bear Trackers Unite!</h1></center>
    <hr class="my-4">
    ...
    <p class="lead">Each year between July and September brown bears in the Katmai National Park congregate along the Brooks River. 
      ...
      and catch the salmon as they jump over rocks.Want to see it in <a href="https://explore.org/livecams/brown-bears/brown-bear-salmon-cam-brooks-falls">ACTION?</a></p>
